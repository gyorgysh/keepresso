...
APP = {
    ...
    "One-click “Stop in” buttons shown in the menu while a session runs, so the Mac goes back to sleeping on its own that much later. Up to four; the list stays sorted.": "Pulsanti “Interrompi tra” a un clic mostrati nel menu mentre una sessione è attiva, così il Mac torna ad addormentarsi da solo dopo quel tempo. Fino a quattro; l’elenco resta ordinato.",
