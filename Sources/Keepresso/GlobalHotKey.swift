...
extension HotKeyShortcut {
    ...
    private static let namedKeys: [Int: String] = [
        ...
        kVK_Shift: "Shift", kVK_RightShift: "Right Shift",
        kVK_Control: "Control", kVK_RightControl: "Right Control",
        kVK_Option: "Option", kVK_RightOption: "Right Option",
        kVK_Command: "Command", kVK_RightCommand: "Right Command",
        kVK_CapsLock: "Caps Lock", kVK_Function: "Fn",
    ]
