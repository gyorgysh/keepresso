    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Keeps running with the lid shut and no external display, on power or battery. Changing this needs your administrator password and flips a system setting (pmset disablesleep), so it stays in effect until you turn it off. On battery and closed it can drain the battery and trap heat, so don't leave it on in a bag.")
                    .font(.caption)
